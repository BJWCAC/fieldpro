...
- **Customer copies withhold equipment part numbers, serial numbers, and pricing** — in the report body, your photo descriptions, AI Observations, and AI Synthesis; the Report tab shows exactly what the customer will see, and one tap on Internal Copy brings the full detail back
...
11. Name the copy under **Report Copy Name** (Customer Copy, Internal Copy, or Other with your own name). A Customer Copy leaves out equipment part numbers, serial numbers, and pricing.
...
19. On a report that mentions a serial number, part number, or price, confirm the Customer Copy withholds them (report body and all three photo text blocks) and Internal Copy shows them.
