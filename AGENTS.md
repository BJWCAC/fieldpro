...
- `node tests/asset-duplicate-serial.js` (plain Node script; required for any change to how an asset save decides between creating and updating a Zoho record)
- `git diff --check`
