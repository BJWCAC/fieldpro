...
- `node tests/replacement-part-research.js` (plain Node script, no deps; required for any change to the replacement part lookup)
- `git diff --check`
