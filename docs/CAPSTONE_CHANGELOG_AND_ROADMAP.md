...
|---------|-----|--------------|
| v376 | #266 | **IA Number full top-row width beside GPS; Name full-width below** — Number and GPS share one aligned top row (Number no longer stacked with Name in a half column). IA Name sits on its own full-width row under that. |
