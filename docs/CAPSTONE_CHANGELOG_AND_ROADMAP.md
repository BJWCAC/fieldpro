...
Current live version: v278
Test URL: https://BJWCAC.github.io/fieldpro/FieldPro.html?v=278
```
...
| v278 | — | **Flow Open Channel suggested defaults** — Input EU H2O Inches, Output 4-20 mA, Display GPM US, Duration 0.75; P005/P006 when Brand Pulsar + Series Ultra 4; refreshes on brand/series change |
