...
|---------|-----|--------------|
| v376 | #267 | **IA Number beside GPS on one row; Name full-width below** — Number and GPS share one aligned top row (Number no longer stacked with Name in a half column). IA Name sits on its own full-width row under that. |
