...
Current live version: v370
Test URL: https://BJWCAC.github.io/fieldpro/FieldPro.html?v=370
```
...
|---------|-----|--------------|
| v370 | #262 | **IA tab: hide unused Equipments site/layout fields** — CapStone IA form no longer shows Asset Category, Asset Function, Building, Additional Designator, Asset Type / Type Other, Series / Series Other, Environment, or Confined Space (still on Assets tab and unchanged in Zoho Internal_Assets). IA required fields are Name, Brand, Model, Serial, Use Status; save omits the hidden fields so updates do not blank Zoho values. |
