...
Current live version: v376
Test URL: https://BJWCAC.github.io/fieldpro/FieldPro.html?v=376
```
...
|---------|-----|--------------|
| v376 | #267 | **IA Number wide beside GPS on one row; Name full-width below** — Number and GPS share the top row (GPS aligned with the number field); Number takes the remaining width, GPS a compact right column. IA Name sits on its own full-width row under that. |
