...
| v286 | — | **Fix FOC category layout load + Duration section** — guard concurrent category renders; safe lookup option handling; Duration (Damping_Seconds) in its own full-width section |
